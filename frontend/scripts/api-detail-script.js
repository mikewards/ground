...
const apiData = {
    'yield-accounts': {
        create: {
            ...
            summary: 'Create a new yield account to start earning interest on cryptocurrency deposits. The platform automatically routes funds to the best available protocol (Morpho or Aave) to ensure 6% yield.',
            ...
            requestBody: [
                ...
                },
                {
                    ...
                    type: 'string',
                    required: false,
                    description: 'Preferred DeFi protocol for this account. Use "auto" to let the platform automatically select the best protocol based on current rates and availability. Specify "morpho" or "aave" to force a specific protocol.',
                    constraints: [
            ...
            requestBody: [
                {
                    ...
                    type: 'string',
                    required: true,
                    description: 'Your account username. This is the username you used when creating your account.',
                    constraints: [
                ...
                },
                {
                    ...
                    type: 'string',
                    required: true,
                    description: 'Your account password. Must be at least 8 characters long.',
                    constraints: [
        ...
        create: {
            ...
            requestBody: [
                ...
                },
                {
                    ...
                    type: 'array',
                    required: false,
                    description: 'An array of allowed CORS origins. These origins will be allowed to make cross-origin requests to the Yield API when using this application\'s API keys.',
                    nested: [
                        {
                            name: 'origin',
                            type: 'string',
...
function updateCurlExample(curlExample) {
    ...
    const urlPatterns = [
        ...
        /https:\/\/api-sandbox\.example\.com/g,
